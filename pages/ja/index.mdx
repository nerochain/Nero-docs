...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-0">
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/ja/getting-started/introduction" className="inline-block no-underline">
      <svg width="115" height="28" viewBox="0 0 115 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-1">
        <rect x="0.5" y="0.5" width="114" height="27" rx="3.5" fill="white" stroke="#000000" className="dark:stroke-white" />
        <text x="12" y="18" fontFamily="system-ui, sans-serif" fontSize="12" fill="#000000" className="dark:fill-white">構築を開始する →</text>
      </svg>
    </a>
  </div>
  ...
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/ja/node-validators/overview" className="inline-block no-underline">
      <svg width="135" height="28" viewBox="0 0 135 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-1">
        <rect x="0.5" y="0.5" width="134" height="27" rx="3.5" fill="white" stroke="#000000" className="dark:stroke-white" />
        <text x="10" y="18" fontFamily="system-ui, sans-serif" fontSize="12" fill="#000000" className="dark:fill-white">インフラを実行する →</text>
      </svg>
    </a>
  </div>
  ...
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/ja/core-concepts" className="inline-block no-underline">
      <svg width="135" height="28" viewBox="0 0 135 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-1">
        <rect x="0.5" y="0.5" width="134" height="27" rx="3.5" fill="white" stroke="#000000" className="dark:stroke-white" />
        <text x="10" y="18" fontFamily="system-ui, sans-serif" fontSize="12" fill="#000000" className="dark:fill-white">テクノロジーを学ぶ →</text>
      </svg>
    </a>
  </div>
</div>
