...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-0">
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/ja/getting-started/introduction" className="text-nero-brand hover:text-nero-dark mt-0 inline-block text-sm border border-nero-brand rounded-md px-2 py-1 hover:bg-nero-brand hover:text-white transition-colors no-underline">構築を開始する →</a>
  </div>
  ...
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/ja/node-validators/overview" className="text-nero-brand hover:text-nero-dark mt-0 inline-block text-sm border border-nero-brand rounded-md px-2 py-1 hover:bg-nero-brand hover:text-white transition-colors no-underline">インフラを実行する →</a>
  </div>
  ...
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/ja/core-concepts" className="text-nero-brand hover:text-nero-dark mt-0 inline-block text-sm border border-nero-brand rounded-md px-2 py-1 hover:bg-nero-brand hover:text-white transition-colors no-underline">テクノロジーを学ぶ →</a>
  </div>
</div>
