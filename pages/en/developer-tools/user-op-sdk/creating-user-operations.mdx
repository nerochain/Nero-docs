...
This section covers how to create different types of UserOperations using the SDK.

## Understanding Minimal UserOperations

Before creating specific transactions, it's important to understand that UserOperations have a standard structure. A minimal UserOperation contains all required fields even if they have placeholder values:
