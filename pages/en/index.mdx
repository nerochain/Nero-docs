...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-0">
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/en/getting-started/introduction" className="inline-block no-underline">
  ...
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/en/node-validators/overview" className="inline-block no-underline">
  ...
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/en/core-concepts" className="inline-block no-underline">
      <svg width="135" height="28" viewBox="0 0 135 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-1">
        <rect x="0.5" y="0.5" width="134" height="27" rx="3.5" fill="white" stroke="#000000" className="dark:stroke-white" />
