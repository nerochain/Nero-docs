...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-0">
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/en/getting-started/introduction" className="text-nero-brand hover:text-nero-dark mt-0 inline-block text-sm border border-nero-brand rounded-md px-2 py-1 hover:bg-nero-brand hover:text-white transition-colors no-underline">Start building →</a>
  </div>
  ...
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/en/node-validators/overview" className="text-nero-brand hover:text-nero-dark mt-0 inline-block text-sm border border-nero-brand rounded-md px-2 py-1 hover:bg-nero-brand hover:text-white transition-colors no-underline">Run infrastructure →</a>
  </div>
  ...
  <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <a href="/en/core-concepts" className="text-nero-brand hover:text-nero-dark mt-0 inline-block text-sm border border-nero-brand rounded-md px-2 py-1 hover:bg-nero-brand hover:text-white transition-colors no-underline">Learn technology →</a>
  </div>
</div>
