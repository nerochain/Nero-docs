# How to Check Supported Tokens for the Nerochain Paymaster

This tutorial explains how to query and display the tokens that are supported by the Nerochain Paymaster for gas fee payments.

## Understanding Supported Tokens

The Nerochain Paymaster allows users to pay gas fees using various ERC20 tokens. However, not all tokens are supported, and the list may vary depending on:
