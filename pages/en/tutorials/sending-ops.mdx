# How to Send Operations to the Nerochain Paymaster API

This tutorial explains how to execute transactions using the Nerochain Paymaster API, focusing on the actual process of building and sending User Operations.
