...
<div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-6">
  <a href="/en/tutorials/high-level/nero-wallet-architecture" className="bg-gray-50 dark:bg-gray-900 p-5 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-blue-500 hover:shadow-md dark:hover:border-blue-400 transition-all no-underline text-current">
  ...
  <a href="/en/tutorials/high-level/nero-wallet-template-quickstart" className="bg-gray-50 dark:bg-gray-900 p-5 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-blue-500 hover:shadow-md dark:hover:border-blue-400 transition-all no-underline text-current">
    <h3 className="text-lg font-semibold mb-2 text-center">💲 Create Your First dApp</h3>
